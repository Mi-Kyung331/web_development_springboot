package me.kangmikyung.springbootdeveloper.repository;
...
/*
    이상의 코드를 통해 JpaRepository 클래스를 상속 받을 때,
    엔티티인 Article과 PK인 Long을 argument로 받았습니다.
    ...
    블로그 글 작성을 위한 API 구현하기
        ...
        서비스 메서드 코드 작성
            ...
            컨트롤러에서 요청한 본문을 받을 객체잉 AddArticleRequest.java 파일을 생성
