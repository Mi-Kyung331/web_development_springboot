...
1. 사전 지식 : 타임리프(Thymeleaf)
    ...
    * 템플릿 엔진 : 스프링 서버에서 데이터를 받아 우리가 보는 웹 페이지,
        ...
        템플릿 엔진 개념 잡기
            ...
            h1 태그에서는 ${이름}이 텍스트 어트리뷰트(속성)로 할당되어있습니다.
            p 태그도 비슷한 상황입니다.
            이상이 템플릿 문법의 예시인데,
            ...
            템플릿 엔진은 각각 문법이 조금씩 다른 편입니다.
            그래서 템블릿 엔진마다 문법을 새로 배워야 하는 단점은 존재합니다만 구조는 그래도 비슷합니다.
            ...
            *{...} - 선택한 변수의 표현식. th:object에서 선택한 객체에 접근
            ...
            th:unless - 조건이 false인 때만 표서 - th:unless"${person.age}>=20"
