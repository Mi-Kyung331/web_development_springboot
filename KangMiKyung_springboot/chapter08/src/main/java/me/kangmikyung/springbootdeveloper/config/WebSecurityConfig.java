package me.kangmikyung.springbootdeveloper.config;


import lombok.RequiredArgsConstructor;
import me.kangmikyung.springbootdeveloper.service.UserDetailService;
...
/*
    ...
    3. 특정 경로에 대한 액세스 설정
        ...
        permitAll() : 누구나 접근 가능하게 설정. 즉, "/login", "/signup", "/user"로 요청이 오면 인증 / 인가 없이도 접근 가능
    ...
    7. 인증 관리자 관련 설정. 사용자 정보를 가져올 서비스를 재정의하거나, 인증 방법,
        예를 들어 LADP, JDBD 기반 인증 등을 설정 할 때 사용
