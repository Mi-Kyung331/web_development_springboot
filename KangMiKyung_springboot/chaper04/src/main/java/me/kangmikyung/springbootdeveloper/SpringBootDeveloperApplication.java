...
/*
    1. 테스트 코드 개념 익히기
        테스트 코드는 작성한 코드가 의도대로 잘 동작하고 예상치 못한 문제가 없는 지 확인 할 목적으로 작성하는 코드
        보통 테스트 코드 관련 공부는 본 개발 공부를 하느라 미루는 경우가 많은데,
        좀 익숙해지면 솔직히 이거 완전 좋습니다.
    ...
    AssertJ로 검증문 가독성 높이기
        ...
        테스트 코드 작성 연습 문제 풀어보기 -> test/java 폴더에 JUnitQuiz.java파일 생성
 */
