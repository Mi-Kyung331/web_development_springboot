...
/*
    New project 생성시 주의점 :
        ...
        6. 앞으로의 수업 시간에는 new project 생성시에 이렇게 자세히 풀이할 일은 자주 있지 않을 예정이니 꼭
            익혀두시길 바랍니다. -> github 본다고 되는 부분이 아니니만큼 신경써주시면 감사하겠습니다.
 */
...
/*
    1. Spring vs. SpringBoot
        ...
        SpringBoot의 등장
            ...
            특징 :
                1) 톰캣, 제티, 언더토우 같은 웹 애플리케이션 서버가 내장되어있어 따로 설치하지 않아도
                    독립적으로 실행 가능
                2) 빌드 구성을 단순화하는 스프링 부트 스타터를 제공
                3) XML 설정을 하지 않고 자바 코드로 작성 가능
                4) JAR를 이용해서 자바 옵셥만으로 배포가 가능
    ...
    2. 스프링 컨셉
        ...
        5) 이식 가능한 서비스 추상화(PSA)
            Portable Service Abstraction : 스프링에서 제공하는 다양한 기술들을 '추상화' 해
                ...
                어떤 기술을 사용하든 일관된 방식으로 데이터베이스에 접근하도록 인텋페이스를 지원
    ...
    3. 스프링 부트 3 둘러보기
        첫 번째 스프링 부트 3 예제 만들기
            ...
            01 단계 - TestController.java 파일을 만들겁니다.
